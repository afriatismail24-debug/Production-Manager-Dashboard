...
export default function ChefsScreen() {
  ...
  const submit = async () => {
    ...
    if (
      ...
      return setError("A chef with this email already exists.");
    ...
    >
      ...
      >
        <Card>
          ...
          >
            Password is generated by signup order — first chef gets 111111,
          ...
          <Button
            label={`Create chef account (password: ${String(chefs.length + 1).repeat(6)})`}
            icon="user-plus"
            onPress={submit}
            fullWidth
            style={{ marginTop: 14 }}
          ...
          >
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  Chef created — share these credentials
                </Text>
                <Text
                  style={{
                    color: colors.accentForeground,
        ...
        <Card>
          ...
          >
            ...
            <Badge tone="primary" label={`${chefs.length} chefs`} />
          </View>
